...
def display_data():
  ...
  pg.draw.rect(screen, "grey0", (c.SCREEN_WIDTH, 0, c.SIDE_PANEL, 400), 1)
  #display data
...
begin_button = Button(c.SCREEN_WIDTH + 65.5, 500, begin_image, True)
restart_button = Button(310, 300, restart_image, True)
fast_forward_button = Button(c.SCREEN_WIDTH + 59, 575, fast_forward_image, False)
